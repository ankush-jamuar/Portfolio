export const PROFILE = {
  name: "Ankush Jamuar",
  shortName: "Ankush.",
  role: "PRODUCT-MINDED DEVELOPER & UI/UX ENTHUSIAST",
  tagline: "who ships",
...
export const SKILLS_CATEGORIES = [
  ...
  {
    label: "Design",
    items: [["Figma", 90], ["Wireframing", 85], ["Prototyping", 88], ["User Flows", 85], ["Information Architecture", 82], ["Design Systems", 85]]
  },
  {
    label: "Tools & Platforms",
    items: [["MongoDB", 85], ["Git/GitHub", 90], ["Postman", 82], ["Canva", 75]]
  },
];
...
export const PROJECTS = [
  {
    ...
    screenshot: "/screenshots/Neuronix.png",
    desc: "AI-powered Personal Knowledge Management platform focused on semantic search, intelligent retrieval, AI-assisted conversations, and seamless knowledge organization.",
    bullets: [
      "Prioritized discoverability and reduced friction in information retrieval",
      "Simplified navigation design for dynamic note organization",
      "Embedded semantic search capability to connect scattered knowledge nodes"
    ],
    tech: ["Next.js", "React", "TypeScript", "PostgreSQL", "Node.js"],
    experience: ["User Experience", "AI Chat", "Semantic Search", "Dashboard Design", "Information Architecture"],
    live: "https://neuronix-eta.vercel.app/",
    github: "https://github.com/ankush-jamuar/Neuronix"
  },
  {
    name: "Sprintify",
    tag: "AI SaaS",
    screenshot: "/screenshots/Sprintify.png",
    desc: "AI-powered project management platform designed to simplify sprint planning, task organization, and team collaboration through intelligent workflows.",
    ...
    experience: ["Workflow Design", "Agile Collaboration", "Real-Time Sync", "Dashboard Design"],
  ...
  },
  {
    ...
    desc: "Online invoicing and billing platform focused on creating a streamlined financial management experience for small businesses and freelancers.",
    ...
    experience: ["Invoicing Workflow", "User Experience", "Financial Dashboards", "Friction Reduction"],
...
export const TRAINING = {
  ...
  tags: ["Java DSA", "OOP"],
  image: "/certs/training.png",
  link: "https://drive.google.com/file/d/1UOrZMzQ9hnm6cpiAimZZaXEJMlfsGpiV/view?usp=drive_link",
  bullets: [
...
export const RESUME_INFO = [
  ...
  { title: "Projects", rows: [["Neuronix", "AI Productivity Platform", "Next.js · PostgreSQL · AI Chat"], ["Sprintify", "AI-Powered PM SaaS", "MERN · GroqAI · Socket.io"], ["Billiant", "Online Invoicing Platform", "MERN · JWT · REST API"]] },
  { title: "Certs", rows: [["Java Programming", null, "iamneo · May 2025"], ["Cloud Computing", null, "NPTEL · Apr 2025"], ["DSA & OOP", null, "iamneo · Dec 2024"]] },
];

export const RESUME_TAGS = ["Product Dev", "Android", "AI Integration", "280+ LC"];
export const RESUME_CORE_SKILLS = ["React.js", "Next.js", "Node.js", "MongoDB", "Express.js", "Kotlin", "Java", "JavaScript", "Socket.io", "Jetpack Compose", "REST API", "Git", "Figma", "Wireframing", "Prototyping", "Design Systems"];

export const BOT_KB = {
  skills: "Next.js, React, TypeScript, Node.js, Kotlin, Android, Tailwind, Socket.io, Figma, Wireframing, Prototyping.",
  neuronix: "AI-powered Personal Knowledge Management platform focused on semantic search, intelligent retrieval, AI-assisted conversations, and seamless knowledge organization.",
  sprintify: "AI-powered project management platform designed to simplify sprint planning, task organization, and team collaboration through intelligent workflows.",
  billiant: "Online invoicing and billing platform focused on creating a streamlined financial management experience for small businesses and freelancers.",
  projects: "Neuronix (AI Productivity Platform), Sprintify (AI PM SaaS), and Billiant (invoicing) — all live and built with strong product focus.",
  ...
  hello: "Hi! I'm Ankush's AI. He's a Product-Minded Developer & UI/UX Enthusiast. Ask me anything!",
